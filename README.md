...
As AI agents proliferate and start transacting autonomously, there's no standard way to assess their trustworthiness. DJD Agent Score produces a **0–100 reputation score** for any wallet by analysing its USDC on-chain history across four dimensions:

| Dimension | Weight | What it measures |
|---|---|---|
| **Payment Reliability** | 35% | Transaction volume, consistency, counterparty diversity |
| **Economic Viability** | 30% | USDC balance, inflow/outflow ratios, wallet age |
| **Identity** | 20% | Wallet age, ERC-8004 registry, voluntary registration, GitHub verification |
| **Capability** | 15% | x402 revenue earned, services operated |
...
Registered wallets receive a **+15 point identity bonus**.
...
Full breakdown including raw dimension data, score history, recommendations, and fraud flags.
...
### ERC-8004 Registry
[ERC-8004](https://eips.ethereum.org/EIPS/eip-8004) (AI Agent Registry) is a proposed standard. The registry contract address in `src/blockchain.ts` is currently the zero address and returns `false` for all wallets until the actual registry is deployed on Base.
